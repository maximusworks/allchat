<h1 align="center"> Public Chat -AllChat </h1>

AllChat is a full-stack AI agent chat tool built using components such as langGraph, FastAPI, NextJS, and Chroma.
...
# MySQL
# DATABASE_URL=mysql+aiomysql://root:root@localhost/allchat
